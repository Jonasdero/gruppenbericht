...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{figures/andre/jungespärchencustomerprofile.JPG}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{figures/andre/jungespärchenvalueproposition.JPG}
